...
private:
    ...
    bool lineIsDictBegin(const QString& line);
    bool lineIsDictEnd(const QString& line);
...
private:
    ...
    static inline const QString DictBegin               = "SUP_ADDTODICT_BEGIN";
    static inline const QString DictEnd                 = "SUP_ADDTODICT_END";
...
private:
    State state = State::LookingForData;
