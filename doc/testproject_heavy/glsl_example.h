...
SUP_VARS_BEGIN
		STR(Rmain, 	rmain) 		ui("")
#line	ooo(Rmain)
		VAR(vec4, ta)			ui("lims = [0,2,1], tab = 3")
		VAR(vec4, tb)			ui("lims = [0,2,1], tab = 3")
		VAR(vec4, tc)			ui("lims = [0,2,1], tab = 3")
		VAR(vec4, td)			ui("lims = [0,2,1], tab = 3")
		VAR(vec4, te)			ui("lims = [-1,1,0], tab = 3")
...
#line	ooo(Lighting)	
		STR(Light, mainlight)
#line	ooo(Light)				
		STR(SNChild, childA) 	ui("tab = 1")
#line	ooo(SNChild)
		STR(SNChild, childB) 	ui("")
#line	ooo(SNChild)
		STR(IQNData, iqn) 		ui("tab = 2")
#line	ooo(IQNData)
		STR(IQNData, iqn2) 		ui("tab = 2")
#line	ooo(IQNData)
		STR(Vor, vor) 			ui("")
#line	ooo(Vor)
		STR(Ring, ring1) 		ui("")
